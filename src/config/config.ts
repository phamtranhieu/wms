...
export const configApp = {
	...
	// hostApi: process.env.REACT_APP_HOST_API || '',
	hostApi: process.env.REACT_APP_HOST_API || '',

	apiPrefix: process.env.REACT_APP_API_PREFIX || '',
	domainHome: process.env.REACT_APP_DOMAIN_HOME || '',

	isMobile,
	appMaxWidth: 1333, // container width
	shadowCss: 'shadow-lg lg:shadow-2xl',
	prefixBreakpointCss: 'lg:',
};
